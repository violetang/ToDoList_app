...
public class DatabaseHelper extends SQLiteOpenHelper{
    ...
    /**
     * Create a user table callded person_table
     */
    ...
    /**
     * Override the onCreate method to execute three tables
     * @param db
     */
    @Override
    ...
    public  Cursor getTodoTaskOfList(){
        SQLiteDatabase db = this.getWritableDatabase();
        Cursor todo_task_data = db.rawQuery("SELECT * FROM "+TASK_TABLE_NAME, null);
